...
const { valueExistsInCollection, required, email, uuid, createValidator } = require('validations');
...
function validatePersonEmailChangeCommand(payload) {
...
module.exports = validatePersonEmailChangeCommand;
